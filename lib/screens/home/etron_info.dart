...
class EtronInfo extends StatefulWidget {
  bool click = true;

  @override
  State<EtronInfo> createState() => _EtronInfoState();
}

class _EtronInfoState extends State<EtronInfo> {
  bool click = true;
                ...
                children: [
                  Container(
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        String url =
                            "https://www.audi.in/in/web/en/models/tron/audi-e-tron-sportback-2021.html";
